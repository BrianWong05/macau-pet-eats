import{u as f,b as g,j as s}from"./index-da4C4Nok.js";import{g as n,P as x}from"./index-HlvzkroW.js";import{U as h,l as p}from"./ui-vendor-BzBFCVgS.js";import{L as N}from"./react-vendor-B-2HpIm1.js";function z({restaurant:e}){const{i18n:t}=f(),a=t.language,{getLocalizedName:r}=g(),{id:u,pet_policy:c,image_url:d}=e,i=n(e,"name",a),j=n(e,"description",a),m=n(e,"address",a),o=n(e,"cuisine_type","en");return s.jsxs(N,{to:`/restaurant/${u}`,className:`
      ...
      `,children:[s.jsxs("div",{className:"flex sm:hidden",children:[s.jsxs("div",{className:"relative w-28 h-28 shrink-0",children:[s.jsx("img",{src:d||"https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400",alt:i,className:"w-full h-full object-cover"}),s.jsx("div",{className:"absolute bottom-1 right-1",children:s.jsxs("span",{className:`
              ...
              rounded-full
            `,children:[s.jsx(h,{size:10}),o.slice(0,1).map(l=>r(l,a)).join("")]})})]}),s.jsxs("div",{className:"flex-1 p-3 flex flex-col justify-center gap-1",children:[s.jsx("h3",{className:"text-base font-semibold text-neutral-900 line-clamp-1",children:i}),s.jsx(x,{policy:c,size:"sm"}),s.jsxs("div",{className:"flex items-center gap-1 text-neutral-500 text-xs",children:[s.jsx(p,{size:10,className:"shrink-0"}),s.jsx("span",{className:"line-clamp-1",children:m})]})]})]}),s.jsxs("div",{className:"hidden sm:block",children:[s.jsxs("div",{className:"relative aspect-[4/3] overflow-hidden",children:[s.jsx("img",{src:d||"https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800",alt:i,className:`
